(function (global, factory) {
    ...
    (global = global || self, factory((global['angular-redux'] = global['angular-redux'] || {}, global['angular-redux'].store = global['angular-redux'].store || {}, global['angular-redux'].store.testing = {}), global['angular-redux'].store, global.ng.core, global.rxjs, global.rxjs.operators));
    ...
    ***************************************************************************** */
    ...
    var MockNgRedux = /** @class */ (function (_super) {
        ...
        MockNgRedux.reset = function () {
            ...
            store.NgRedux.instance = MockNgRedux.mockInstance;
        };
        /**
